...
define KernelPackage/dsa-b53
  ...
  DEPENDS:=+kmod-dsa +kmod-dsa-notag +kmod-of-mdio
  KCONFIG:=CONFIG_B53 \
...
define KernelPackage/dsa-mt7530
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=MediaTek MT7530/MT7531 ethernet switch DSA driver
  DEPENDS:=+kmod-dsa +kmod-dsa-notag +kmod-of-mdio
  KCONFIG:= \
  ...
  AUTOLOAD:=$(call AutoProbe,mt7530-mdio)
endef

define KernelPackage/dsa-mt7530/description
  MediaTek MT7530/MT7531 family managed switch DSA driver,
  used in econet EN751221 (mediatek,mcm), MT7621, MT7622 SoCs.
endef
