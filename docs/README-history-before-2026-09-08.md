...
> **Historical README, archived on 8 September 2026.** Preserved for the older
> overlay and its development history. Status and hardware claims below may
> be outdated; paths and commands refer to the repository root. These are not
> instructions for reproducing the newer GPON integration. Start with the
> [current project overview](../README.md) and the notes for your exact release.
