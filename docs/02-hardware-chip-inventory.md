...
| **DRAM** | DDR3 (256 MB) — part marking not read (size bootloader-confirmed) | System RAM | on-SoC DDR ctrl | — | Working, 244 MB usable |
| **Ethernet magnetics** | 2× **JWD SG48001G** | 10/100/1000 BASE-T dual-port transformers | between switch ↔ 4× RJ45 | — (passive) | — |
